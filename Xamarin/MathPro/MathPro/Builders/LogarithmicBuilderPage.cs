...
namespace MathPro.Builders
{
	...
	public class LogarithmicBuilderPage : Activity
	{
		private readonly Helper _helper = new Helper();
		private LogarithimsBuilder _builder;

		private readonly ISharedPreferences _defaultSharedPreferences =
		...
		private void Start()
		{
			...
			_builder = new LogarithimsBuilder(ref timer, this);
