...
namespace MathPro.Geometry
{
	...
	public class PlotGeoShape : Activity
	{
		...
		{
			var grid = new RelativeLayout(this) {LayoutParameters = new ViewGroup.LayoutParams(200, 260)};
			grid.SetBackgroundResource(Resource.Drawable.border);

			var button = new Button(this) {Text = "Add"};
			button.Click += AddClicked;
			button.LayoutParameters = new RelativeLayout.LayoutParams(180,80){TopMargin =90, LeftMargin = 7};
