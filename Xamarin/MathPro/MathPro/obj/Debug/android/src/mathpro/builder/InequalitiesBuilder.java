...
public class InequalitiesBuilder
		...
		mono.android.IGCUserPeer
{
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("MathPro.Builder.InequalitiesBuilder, MathPro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", InequalitiesBuilder.class, __md_methods);
	}


	public InequalitiesBuilder (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == InequalitiesBuilder.class)
			mono.android.TypeManager.Activate ("MathPro.Builder.InequalitiesBuilder, MathPro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public InequalitiesBuilder (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == InequalitiesBuilder.class)
			mono.android.TypeManager.Activate ("MathPro.Builder.InequalitiesBuilder, MathPro, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public InequalitiesBuilder (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == InequalitiesBuilder.class)
	...
	public InequalitiesBuilder (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == InequalitiesBuilder.class)
